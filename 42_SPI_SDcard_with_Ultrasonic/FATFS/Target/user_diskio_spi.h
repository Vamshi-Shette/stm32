...
#define FCLK_SLOW() { MODIFY_REG(SD_SPI_HANDLE.Instance->CR1, SPI_CR1_BR_Msk, SPI_BAUDRATEPRESCALER_256); }
// Force 4 prescaler for Fast (approx 21 MHz)
#define FCLK_FAST() { MODIFY_REG(SD_SPI_HANDLE.Instance->CR1, SPI_CR1_BR_Msk, SPI_BAUDRATEPRESCALER_4); }
